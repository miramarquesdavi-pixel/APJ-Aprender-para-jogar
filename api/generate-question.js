...
- As 3 questões do mesmo lote devem abordar ângulos diferentes: varie contexto, tipo de raciocínio e forma do enunciado.
- Não faça apenas trocas de números ou sinônimos para parecer uma questão nova.
- Se o tema permitir, alterne entre aplicação prática, interpretação, comparação e resolução de problema.
...
- Nunca repita nem parafraseie as perguntas listadas no histórico; crie uma situação realmente diferente.
